...
\vspace{0.5cm}
%%%%%%%%%%%%%%%%%
    \textbf{Bipolar Transistor} - A type of transistor that uses both electrons and electron holes as charge carriers.  It has three different sections of semiconductor material known as the base, collector, and emitter.
    %%%%%%%%%%%%%%%%%
    \vspace{0.15cm}
    %%%%%%%%%%%%%%%%%
    \begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{C}
    \textbf{Carriers} - The entities that transport charge from place to place inside a material and hence give rise to electrical currents.  Most of the carriers are grouped energetically in the near vicinity of the conduction band edge or valence band edge.
