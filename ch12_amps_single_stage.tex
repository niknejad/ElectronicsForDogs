...
Assuming that $r_o \gg R_L$, we have:
    ...
    \end{equation}
This final result leads to another name for this amplifier, namely the \textbf{"Source Follower"}\index{Amplifier!source follower}, because the source voltage closely tracks the gate voltage.  In other words, this is a voltage amplifier with unity gain, or a voltage buffer.
